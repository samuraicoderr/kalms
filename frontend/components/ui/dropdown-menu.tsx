...
>(({ className, sideOffset = 4, collisionPadding = 8, ...props }, ref) => (
  <DropdownMenuPortal>
    <DropdownMenuPrimitive.Content
      ...
      sticky="always"
      className={cn(
        "z-50 min-w-[8rem] max-w-[calc(100vw-0.75rem)] max-h-[var(--radix-dropdown-menu-content-available-height)] overflow-y-auto overflow-x-hidden rounded-md border border-gray-200 bg-white p-1 text-gray-950 shadow-md",
        className
      )}
      {...props}
    />
